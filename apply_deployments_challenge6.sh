...
kubectl apply -f scripts/challenge-6/poi-deployment.yaml
kubectl apply -f scripts/challenge-6/trips-deployment.yaml
kubectl apply -f scripts/challenge-6/tripviewer-deployment.yaml
kubectl apply -f scripts/challenge-6/user-deployment.yaml
kubectl apply -f scripts/challenge-6/userprofile-deployment.yaml

kubectl apply -f scripts/challenge-6/poi-service.yaml
kubectl apply -f scripts/challenge-6/trips-service.yaml
kubectl apply -f scripts/challenge-6/user-service.yaml
kubectl apply -f scripts/challenge-6/userprofile-service.yaml
kubectl apply -f scripts/challenge-6/tripviewer-service.yaml

kubectl apply -f scripts/challenge-6/sql-secret-keyvault.yaml

kubectl apply -f scripts/challenge-6/api-dev-role.yaml
kubectl apply -f scripts/challenge-6/api-dev-rolebinding.yaml

kubectl apply -f scripts/challenge-6/web-dev-role.yaml
kubectl apply -f scripts/challenge-6/web-dev-rolebinding.yaml

kubectl apply -f scripts/challenge-6/api-ingress.yaml
kubectl apply -f scripts/challenge-6/web-ingress.yaml

# kubectl create namespace insurance

kubectl apply -f scripts/challenge-6/insurance-deployment.yaml
kubectl apply -f scripts/challenge-6/insurance-service.yaml
...
# https://vincentlauzon.com/2019/05/09/monitoring-metrics-in-aks/

# https://samcogan.com/collecting-prometheus-metrics-with-azure-monitor/